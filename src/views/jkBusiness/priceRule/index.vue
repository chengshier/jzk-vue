...
export default {
  ...
  methods:{
    ...
    searchProducts(keyword){this.productLoading=true;productLstApi({page:1,limit:30,type:1,keywords:keyword||''}).then(res=>{const data=res&&res.data?res.data:res;this.productOptions=(data&&data.list)||[]}).finally(()=>{this.productLoading=false})},
